...
> **快速导航**: [入门](#getting-started) | [架构](#architecture) | [指南](#guides) | [系统](#systems) | [集成](#integrations) | [参考](#reference)
...
| 文档 | 说明 |
|------|------|
| [AI_QUICK_START.md](getting-started/AI_QUICK_START.md) | AI 快速入门指南 |
| [QUICK_CHARGE_GUIDE.md](getting-started/QUICK_CHARGE_GUIDE.md) | 快速充电指南 |
| [NEW_AI_ONBOARDING.md](getting-started/NEW_AI_ONBOARDING.md) | 新 AI 入职指南 |
...
| 文档 | 说明 |
|------|------|
| [AGENT_ID_SYSTEM.md](reference/AGENT_ID_SYSTEM.md) | Agent ID 系统 |
| [AGENT_API.md](reference/AGENT_API.md) | Agent API 参考 |
| [ISSUE_TRACKING.md](reference/ISSUE_TRACKING.md) | Issue 追踪系统 |
...
| 文档 | 说明 |
|------|------|
| [learning_memory_metabolism.md](features/learning_memory_metabolism.md) | 学习记忆新陈代谢 |
| [dynamic_reminder_templates.md](features/dynamic_reminder_templates.md) | 动态提醒模板 |

## Reviews / 评审

当前月份的评审报告存放在 `reviews/` 目录。

历史评审报告存放在 `archive/YYYY-MM/reviews/` 目录。
...
1. 阅读 [AI_QUICK_START.md](getting-started/AI_QUICK_START.md)
2. 阅读 [NEW_AI_ONBOARDING.md](getting-started/NEW_AI_ONBOARDING.md)
3. 阅读 [NEVER_DECLARE_DONE.md](reference/NEVER_DECLARE_DONE.md)
4. 阅读 [SOP.md](guides/SOP.md)

### For Developers / 开发者

1. 阅读 [DEVELOPER_GUIDE.md](guides/DEVELOPER_GUIDE.md)
2. 阅读 [ARCHITECTURE.md](architecture/ARCHITECTURE.md)
3. 阅读 [SERVICE_CATALOG.md](architecture/SERVICE_CATALOG.md)

### For Integration / 集成开发

1. 阅读 [INTEGRATION_ARCHITECTURE.md](architecture/INTEGRATION_ARCHITECTURE.md)
2. 阅读 [OPENCODE_INTEGRATION.md](integrations/OPENCODE_INTEGRATION.md)
3. 阅读 [TRAE_COMPATIBILITY.md](integrations/TRAE_COMPATIBILITY.md)
...
1. **位置规则**: 新文档应放入对应目录
2. **命名规则**: 使用英文命名，遵循现有风格
3. **归档规则**: 超过 30 天的评审报告移至 archive/
4. **索引更新**: 新增文档需更新本 README
