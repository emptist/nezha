...
> Complete documentation for the skill ecosystem, security model, and lifecycle management.

## Overview

Nezha's skill system is a **DB-first, security-hardened** skill management platform that enables:

1. **External skills** from ClawHub marketplace (with safety review)
2. **Internally-built skills** generated by AI
3. **Auto-learned skills** from task review patterns
4. **Centralized PostgreSQL storage** as single source of truth
5. **Multi-layer security** from scanning to execution
