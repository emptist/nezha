...
**Migration File**: [src/db/migrations/051_fix_agent_identity.sql](../src/db/migrations/051_fix_agent_identity.sql)

The schema has been fixed by merging both schemas. The actual migration file content:
...
The table now contains all columns from both the original migration 030 and the OpenCode AI's additions:

| Column         | Source        | Status   |
| -------------- | ------------- | -------- |
| `agent_name`   | Migration 051 | ✅ Added |
| `capabilities` | Migration 051 | ✅ Added |
| `last_seen_at` | Migration 051 | ✅ Added |
| `metadata`     | Migration 051 | ✅ Added |
| `description`  | Migration 051 | ✅ Added |
| `project_id`   | OpenCode AI   | ✅ Kept  |
| `role`         | OpenCode AI   | ✅ Kept  |
| `background`   | OpenCode AI   | ✅ Kept  |
| `expertise`    | OpenCode AI   | ✅ Kept  |

**Migration 051 Changes**:

1. Added missing columns from original migration 030 (`agent_name`, `capabilities`, `last_seen_at`, `metadata`, `description`)
2. Made `project_id` nullable to support non-project agents
3. Updated `register_agent()` function to work with merged schema using `agent_name` as conflict target
